        ...
        <fieldset class="fieldset w-md bg-base-200 border border-base-300 p-4 rounded-box">
            ...
            <div class="avatar flex flex-col gap-2 items-center  mx-auto">
                <div id="upload"
                    ...
                    <img id="preview" src="{{ asset('images/upload.png') }}" />
            ...
            <input type="number" name="document" class="input rounded-full w-full" placeholder="75000001"
                value="{{ old('document') }}" />

            <label class="fieldset-label">FullName:</label>
            <input type="text" name="fullname" class="input rounded-full w-full" placeholder="John Wick"
                value="{{ old('fullname') }}" />
            ...
            <input type="text" name="phone" class="input rounded-full w-full" placeholder="3210000001"
                value="{{ old('phone') }}" />
