...
@section('content')
    ...
    <h1 class="text-3xl flex gap-1 items-center text-white mt-15 mb-2 pb-1 border-b-1">
    ...
    <div class="overflow-x-auto my-2 rounded-box bg-base-100 max-w-4xl mx-auto">
